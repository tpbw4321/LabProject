//*****************************************************************************
// This program sets up two USB Bulk Transfers between the USB host and the devce.
// It transmits a 64-byte block of data to the device using an OUT transfer.
// It then performs an IN transfer from the device to receive the looped-back data.
//
// A. Varma, Oct 23, 2017
//*****************************************************************************
...
int main (int argc, char * argv[]){
  ...
  return_val = libusb_bulk_transfer(dev, // Handle for the USB device
				    ...
				    tx_data, // address of data block to transmit
